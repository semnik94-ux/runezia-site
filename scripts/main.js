...
// ============================================================
const RUNE_DB = [
  { name: 'Огонь', cat: 'Семейство', desc: 'Красный. Интеллект. Урон, поджог, разрушение. Примеры: Огненный шар, Стена пламени, Инферно.' },
  { name: 'Вода', cat: 'Семейство', desc: 'Голубой. Мудрость. Замедление, охлаждение, исцеление. Примеры: Ледяная стрела, Кольцо холода, Метель.' },
  { name: 'Земля', cat: 'Семейство', desc: 'Коричневый. Телосложение. Защита, барьеры, дробящий урон. Примеры: Каменная кожа, Земляной шип, Землетрясение.' },
  { name: 'Воздух', cat: 'Семейство', desc: 'Белый. Ловкость. Скорость, молнии, невидимость. Примеры: Молния.' },
  { name: 'Пустота', cat: 'Семейство', desc: 'Тёмно-фиолетовый. Интеллект. Отрицание, забвение. Примеры: Копьё пустоты, Тёмный ритуал.' },
  { name: 'Свет', cat: 'Семейство', desc: 'Жёлтый. Мудрость. Исцеление, очищение. Примеры: Светоч очищения, Небесное сияние, Божественный щит.' },
  { name: 'Тьма', cat: 'Семейство', desc: 'Чёрный. Харизма. Страх, ослепление, кража сил.' },
  { name: 'Время', cat: 'Семейство', desc: 'Зелёный. Мудрость. Ускорение, замедление, предвидение.' },
  { name: 'Разум', cat: 'Семейство', desc: 'Фиолетовый. Интеллект. Контроль разума, внушение.' },
  { name: 'Тело', cat: 'Семейство', desc: 'Оранжево-коричневый. Сила. Физ. усиление, регенерация. Примеры: Рассекающий удар.' },
  { name: 'Кровь', cat: 'Семейство', desc: 'Тёмно-красный. Телосложение. Вампиризм, жертва. Примеры: Вытягивание крови, Вампирическое касание, Кровавая жертва.' },
  { name: 'Кость', cat: 'Семейство', desc: 'Костяной. Телосложение. Некромантия, укрепление скелета.' },
  { name: 'Рост', cat: 'Семейство', desc: 'Зелёный. Мудрость. Исцеление, усиление, природа.' },
  { name: 'Тлен', cat: 'Семейство', desc: 'Коричнево-серый. Интеллект. Яды, разложение. Примеры: Отравленный клинок, Касание тлена, Отравленная стрела.' },
  { name: 'Дух', cat: 'Семейство', desc: 'Сине-фиолетовый. Харизма. Призыв, изгнание, астрал.' },
  { name: 'Хаос', cat: 'Семейство', desc: 'Пурпурный. Харизма. Случайность, непредсказуемые эффекты.' },
  { name: 'Порядок', cat: 'Семейство', desc: 'Синий. Интеллект. Стабилизация, защита, закон.' },
  { name: 'Сон', cat: 'Семейство', desc: 'Лавандовый. Мудрость. Иллюзии, усыпление.' },
  { name: 'Эхо', cat: 'Семейство', desc: 'Голубовато-белый. Интеллект. Дублирование, отражение.' },
  { name: 'Душа', cat: 'Семейство', desc: 'Розовый. Харизма. Связывание душ, обмен, жертва.' },
  { name: 'Судьба', cat: 'Семейство', desc: 'Золотой. Мудрость. Вероятности, предопределение.' },
];
...
const WIKI_PAGES = [
  ...
  { title: 'Семейства рун',    file: 'runes.html',        desc: '21 семейство рун — стихии, ранги, примеры способностей' },
