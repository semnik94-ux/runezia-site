...
// ============================================================
const RUNE_DB = [
  { rune: 'ᚠ', name: 'Феху', cat: 'Базовая', desc: 'Руна богатства и скотоводства. Даёт приток эссенции.' },
  { rune: 'ᚢ', name: 'Уруз', cat: 'Базовая', desc: 'Руна силы и выносливости. Укрепляет тело.' },
  { rune: 'ᚦ', name: 'Турисаз', cat: 'Базовая', desc: 'Руна защиты и разрушения. Шип великана.' },
  { rune: 'ᚨ', name: 'Ансуз', cat: 'Базовая', desc: 'Руна знания и магии. Связь с богами.' },
  { rune: 'ᚱ', name: 'Райдо', cat: 'Базовая', desc: 'Руна пути и странствий. Ускоряет передвижение.' },
  { rune: 'ᚲ', name: 'Кеназ', cat: 'Базовая', desc: 'Руна огня и творчества. Факел.' },
  { rune: 'ᚷ', name: 'Гебо', cat: 'Базовая', desc: 'Руна дара и партнёрства. Укрепляет союзы.' },
  { rune: 'ᚹ', name: 'Вуньо', cat: 'Базовая', desc: 'Руна радости и гармонии. Снимает проклятие.' },
  { rune: 'ᚺ', name: 'Хагалаз', cat: 'Стихийная', desc: 'Руна града и разрушения. Мощный урон.' },
  { rune: 'ᚾ', name: 'Наутиз', cat: 'Стихийная', desc: 'Руна нужды и выживания. Сила через боль.' },
  { rune: 'ᛁ', name: 'Иса', cat: 'Стихийная', desc: 'Руна льда и застоя. Замедляет врагов.' },
  { rune: 'ᛃ', name: 'Йера', cat: 'Редкая', desc: 'Руна урожая и циклов. Восстанавливает эссенцию.' },
  { rune: 'ᛇ', name: 'Эйваз', cat: 'Редкая', desc: 'Руна защиты. Древо тиса.' },
  { rune: 'ᛈ', name: 'Пертро', cat: 'Редкая', desc: 'Руна тайны и судьбы. Раскрывает скрытое.' },
  { rune: 'ᛉ', name: 'Альгиз', cat: 'Редкая', desc: 'Руна защиты. Рога лося.' },
  { rune: 'ᛊ', name: 'Совило', cat: 'Редкая', desc: 'Руна солнца и победы. Мощный свет.' },
  { rune: 'ᛏ', name: 'Тейваз', cat: 'Эпическая', desc: 'Руна воина и правосудия. Усиливает атаку.' },
  { rune: 'ᛒ', name: 'Беркано', cat: 'Эпическая', desc: 'Руна роста и рождения. Исцеляет.' },
  { rune: 'ᛖ', name: 'Эваз', cat: 'Эпическая', desc: 'Руна доверия и партнёрства. Союз с духом.' },
  { rune: 'ᛗ', name: 'Манназ', cat: 'Эпическая', desc: 'Руна человека и разума. Усиливает интеллект.' },
  { rune: 'ᛚ', name: 'Лагуз', cat: 'Эпическая', desc: 'Руна воды и потока. Адаптация.' },
  { rune: 'ᛝ', name: 'Ингауз', cat: 'Легендарная', desc: 'Руна плодородия. Новая жизнь.' },
  { rune: 'ᛟ', name: 'Отал', cat: 'Легендарная', desc: 'Руна наследия и дома. Защита рода.' },
  { rune: 'ᛞ', name: 'Дагаз', cat: 'Легендарная', desc: 'Руна дня и прорыва. Трансформация.' },
];
...
const WIKI_PAGES = [
  ...
  { title: 'Руны',             file: 'runes.html',        desc: '24 руны Футарка — значения, свойства, применение' },
